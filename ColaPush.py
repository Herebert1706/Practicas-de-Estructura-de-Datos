...
#Defino mi funcion encolat en la cual dentro de ella hago un inf diciendo que si mi indice es igual a tal valor me va a pedir que ingrese un valor para la cola
